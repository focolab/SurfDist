    ...
    def setup_vertices_faces(self):
        ...
        if n == 6:
            ...
            verts = np.array([
                ...
                [ 4.4721359e-01,  0.0000000e+00,  8.9442718e-01],
                [ 4.4721359e-01,  8.5065079e-01,  2.7639320e-01],
                [ 4.4721359e-01,  5.2573109e-01, -7.2360682e-01],
                [ 4.4721359e-01, -5.2573109e-01, -7.2360682e-01],
                [ 4.4721359e-01, -8.5065079e-01,  2.7639320e-01],
                [-4.4721359e-01,  5.2573109e-01,  7.2360682e-01],
                [-4.4721359e-01,  8.5065079e-01, -2.7639320e-01],
                [-4.4721359e-01,  1.0953574e-16, -8.9442718e-01],
                [-4.4721359e-01, -8.5065079e-01, -2.7639320e-01],
                [-4.4721359e-01, -5.2573109e-01,  7.2360682e-01],
                [-1.0000000e+00,  0.0000000e+00,  0.0000000e+00]], dtype=float)
